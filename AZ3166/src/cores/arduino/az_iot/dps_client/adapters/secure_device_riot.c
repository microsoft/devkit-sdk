...
static const SEC_X509_INTERFACE sec_riot_interface =
{
    ...
    secure_device_riot_get_device_cert,
    secure_device_riot_get_root_cert,
    secure_device_riot_get_root_key,
...
static int produce_device_cert(DPS_SECURE_DEVICE_INFO* riot_info)
{
...
DPS_SECURE_DEVICE_HANDLE secure_device_riot_create()
{
...
void secure_device_riot_destroy(DPS_SECURE_DEVICE_HANDLE handle)
{
    /* Codes_SRS_SECURE_DEVICE_RIOT_07_007: [ if handle is NULL, secure_device_riot_destroy shall do nothing. ] */
    if (handle != NULL)
    {
        /* Codes_SRS_SECURE_DEVICE_RIOT_07_008: [ secure_device_riot_destroy shall free the DPS_SECURE_DEVICE_HANDLE instance. ] */
...
char* secure_device_riot_get_certificate(DPS_SECURE_DEVICE_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
char* secure_device_riot_get_alias_key(DPS_SECURE_DEVICE_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
char* secure_device_riot_get_device_cert(DPS_SECURE_DEVICE_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
char* secure_device_riot_get_signer_cert(DPS_SECURE_DEVICE_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
char* secure_device_riot_get_root_cert(DPS_SECURE_DEVICE_HANDLE handle)
{
    char* result = "\0";
    return result;
}

char* secure_device_riot_get_root_key(DPS_SECURE_DEVICE_HANDLE handle)
{
    char* result = "\0";
    return result;
}

char* secure_device_riot_get_common_name(DPS_SECURE_DEVICE_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
const SEC_X509_INTERFACE* secure_device_riot_interface()
{
