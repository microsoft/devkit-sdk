...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_001: [ The tlsio_mbed_os5_tls shall implement and export all the Concrete functions in the VTable IO_INTERFACE_DESCRIPTION defined in the `xio.h`. ]*/
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_002: [ The tlsio_mbed_os5_tls shall report the open operation status using the IO_OPEN_RESULT enumerator defined in the `xio.h`.]*/
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_003: [ The tlsio_mbed_os5_tls shall report the send operation status using the IO_SEND_RESULT enumerator defined in the `xio.h`. ]*/
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_004: [ The tlsio_mbed_os5_tls shall call the callbacks functions defined in the `xio.h`. ]*/
#include "azure_c_shared_utility/tlsio_mbedtls.h"
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_005: [ The tlsio_mbed_os5_tls shall received the connection information using the TLSIO_CONFIG structure defined in `tlsio.h`. ]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_006: [ The phrase "indicate error" means the adapter shall call the on_io_error function and pass the on_io_error_context that was supplied in tlsio_mbed_os5_tls. ]*/
...
static void indicate_open_complete(TLS_IO_INSTANCE* tls_io_instance, IO_OPEN_RESULT open_result)
{
    ...
    {
        /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_007: [ The tlsio_mbed_os5_tls shall report the open operation status using the IO_OPEN_RESULT enumerator defined in the `xio.h`.]*/
...
static int decode_ssl_received_bytes(TLS_IO_INSTANCE* tls_io_instance)
{
    ...
    while (rcv_bytes > 0)
    {
        ...
        if (rcv_bytes > 0)
        {
            /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_008: [ If the receive process is able to receive the data, the tlsio_mbed_os5_tls shall call on_bytes_received along with its associated received data.]*/
...
static int on_handshake_done(mbedtls_ssl_context* ssl, void* context)
{
    ...
    {
        /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_009: [ The phase 'TLSIO_STATE_IN_HANDSHAKE' means the adapter is already shaking hand with the server and waiting for hand shake complete.]*/
...
static int mbedtls_connect(void* context) {
    ...
    /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_010: [ Adapter should keep shaking when the return value is MBEDTLS_ERR_SSL_WANT_READ & MBEDTLS_ERR_SSL_WANT_WRITE. 0 means shakehand completed]*/
    do {
...
static void on_underlying_io_open_complete(void* context, IO_OPEN_RESULT open_result)
{
    ...
    {
        /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_011: [ If open_result is not in correct state, indicate open complete with error. ]*/
    ...
    else
    {
        ...
        if (result != 0)
        {
            /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_012: [ If the connection of mbedtls failed, indicate open complete with error. ]*/
            indicate_open_complete(tls_io_instance, IO_OPEN_ERROR);
        }
    }
}
...
{
    TLS_IO_INSTANCE* tls_io_instance = (TLS_IO_INSTANCE*)context;
    /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_013: [ on_underlying_io_error shall make sure tls_io_instance->tlsio_state is set correctly on error. ]*/
...
static void on_underlying_io_close_complete(void* context)
{
    ...
    /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_014: [ the tlsio_mbed_os5_tls shall call on_io_close_complete along with its associated context.]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_014: [ The tlsio_mbedtls_retrieveoptions shall not do anything, and return NULL. ]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_015: [ The tlsio_mbed_os5_tls shall received the connection information using the TLSIO_CONFIG structure defined in `tlsio.h`. ]*/
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_016: [ The tlsio_mbedtls_create shall create a new instance of the tlsio for mbed TLS. ]*/
CONCRETE_IO_HANDLE tlsio_mbedtls_create(void* io_create_parameters)
{
    TLSIO_CONFIG* tls_io_config = (TLSIO_CONFIG*)io_create_parameters;
    TLS_IO_INSTANCE* result;

    /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_017: [ The tlsio_mbedtls_create shall return NULL when io_create_parameters is NULL. ]*/
    ...
    {
        /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_018: [ The tlsio_mbedtls_create shall allocate memory to control the tlsio instance. ]*/
        ...
        if (result != NULL)
        {
            ...
            {
            /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_018: [ The tlsio_mbedtls_create shall initialize all callback pointers as NULL. ]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_019: [ The tlsio_mbedtls_destroy shall destroy a created instance of the tlsio for mbed os5 identified by the CONCRETE_IO_HANDLE. ]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_020: [ The tlsio_mbedtls_open shall start the process to open the ssl connection with the socket_io provided in the tlsio_mbedtls_create. ]*/
int tlsio_mbedtls_open(CONCRETE_IO_HANDLE tls_io, ON_IO_OPEN_COMPLETE on_io_open_complete, void* on_io_open_complete_context, ON_BYTES_RECEIVED on_bytes_received, void* on_bytes_received_context, ON_IO_ERROR on_io_error, void* on_io_error_context)
{
    ...
    if (tls_io == NULL)
    {
        /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_021: [ If the tls_io handle is NULL, the tlsio_mbedtls_open shall not do anything, and return _LINE_. ]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_022: [ The tlsio_mbedtls_close shall close the underlying socket_io connection. ]*/
int tlsio_mbedtls_close(CONCRETE_IO_HANDLE tls_io, ON_IO_CLOSE_COMPLETE on_io_close_complete, void* callback_context)
{
    ...
    else
    {
        ...
        else
        {
            ...
            /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_023: [ If tlsio_mbedtls_close fails to shutdown underlying socket_io, it shall return _LINE_. ]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_024: [ The tlsio_mbedtls_send shall send all bytes in a buffer to mbed os5 tls connection. ]*/
int tlsio_mbedtls_send(CONCRETE_IO_HANDLE tls_io, const void* buffer, size_t size, ON_SEND_COMPLETE on_send_complete, void* callback_context)
{
    ...
    else
    {
        ...
        if (tls_io_instance->tlsio_state != TLSIO_STATE_OPEN)
        {
            /* Codes_SRS_TLSIO_MBED_OS5_TLS_99_025: [ If the tlsio state is not TLSIO_STATE_OPEN, the tlsio_mbedtls_send shall return _LINE_. ]*/
            result = __LINE__;
        }
        else
        {
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_026: [ The tlsio_mbedtls_dowork shall execute the async jobs for the tlsio. ]*/
...
/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_027: [ The tlsio_mbedtls_get_interface_description shall return the VTable IO_INTERFACE_DESCRIPTION. ]*/
...
int tlsio_mbedtls_setoption(CONCRETE_IO_HANDLE tls_io, const char* optionName, const void* value)
{
    ...
    {
		/* Codes_SRS_TLSIO_MBED_OS5_TLS_99_028: [ If the tlsio io is null or the option is not provided, the tlsio_mbedtls_setoption shall return _LINE_. ]*/
        result = __FAILURE__;
    }
    else
    {
        ...
        // Update the mbedtls connection when the optionName = TrustedCerts
        ...
        // Update the mbedtls connection when the optionName = x509certificate
        ...
        // Update the mbedtls connection when the optionName = x509privatekey
