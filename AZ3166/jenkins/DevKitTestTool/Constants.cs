namespace DevKitTestTool
{
    ...
    public static class Constants
    {
        ...
        internal static readonly string ArduinoArgTemplate = "--board AZ3166:stm32f4:MXCHIP_AZ3166:upload_method=OpenOCDMethod --{0} \"{1}\" --pref build.path=\"{2}\"";

        internal static readonly int Timeout = 60 * 30;

        internal static readonly string FirmwareVersionString = "_FIRMWARE_VERSION_";
    }
}
