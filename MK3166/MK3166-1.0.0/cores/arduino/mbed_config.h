...
#define MBED_CONF_APP_NETWORK_INTERFACE             SPWFSAINTERFACE            // set by application
...
#define MBED_CONF_APP_SPWFSA_TX                     D8                         // set by application
#define MBED_CONF_PLATFORM_STDIO_CONVERT_NEWLINES   0                          // set by library:platform
#define MBED_CONF_APP_WIFI_PASSWORD                 "Password01!"              // set by application
#define MBED_CONF_EVENTS_PRESENT                    1                          // set by library:events
#define MBED_CONF_RTOS_PRESENT                      1                          // set by library:rtos
#define MBED_CONF_PLATFORM_STDIO_BAUD_RATE          9600                       // set by library:platform
#define MBED_CONF_APP_SPWFSAINTERFACE_DEBUG         0                          // set by application
#define MBED_CONF_APP_WIFI_SSID                     "Ruff_R0101965"            // set by application
#define MBED_CONF_PLATFORM_STDIO_FLUSH_AT_EXIT      1                          // set by library:platform
#define MBED_CONF_APP_SPWFSA_RX                     D2                         // set by application
// Macros
